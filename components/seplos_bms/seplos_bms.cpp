...
void SeplosBms::on_telemetry_data_(const std::vector<uint8_t> &data) {
  ...
  this->publish_state_(this->state_of_charge_sensor_, (float) ((float)residual_capacity_sensor_ / (float)battery_capacity_sensor_) * 100f); // there is no direct state of charge it seems - must be calculated
